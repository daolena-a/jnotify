...
%.o: $(ROOT)/%.c
	...
	@echo gcc -I/System/Library/Frameworks/JavaVM.framework/Headers -O3 -Wall -Werror -c -fmessage-length=0 -fPIC -arch ppc -arch ppc64 -arch i386 -arch x86_64 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.5 -o $@ $<
	@gcc -I/System/Library/Frameworks/JavaVM.framework/Headers -O3 -Wall -Werror -c -fmessage-length=0 -fPIC -arch ppc -arch ppc64 -arch i386 -arch x86_64 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.5 -o $@ $< && \
